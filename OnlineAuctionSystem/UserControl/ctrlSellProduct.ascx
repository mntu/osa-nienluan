        ...
        <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
            <div id="divCateId" runat="server" align="center">
                <div style="width: 250px; text-align: left;">
                    Loại Sản Phẩm - Mức phí<br />
                    <asp:ListBox ID="listCate" runat="server" Rows="10" Width="250px"></asp:ListBox>
                    <div align="center">
                ...
                <table align="center">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <br />
                            <dx:ASPxLabel ID="lblAllowebMimeType" runat="server" Text="Loại ảnh: .jpg, .jpe, .jpeg">
                            </dx:ASPxLabel>
                            <br />
                        ...
                        <td colspan="2">
                            <dx:ASPxTextBox ID="txtAmount" runat="server" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                ...
                                <ValidationSettings>
                                    ...
                                    <RegularExpression ErrorText="Số lượng phải là số!" ValidationExpression="\d+" />
                    ...
                    <tr>
                        ...
                        <td width="120px">
                            <dx:ASPxButton ID="btnBack" runat="server" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css" Text="Trở Lại"
                                OnClick="btnBack_Click" Width="100px" CausesValidation="False">
                            </dx:ASPxButton>
                        </td>
                        <td>
                            <dx:ASPxButton ID="btnCreate" runat="server" CssFilePath="~/App_Themes/Aqua/{0}/styles.css"
                                CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css" Text="Hoàn Tất"
                                OnClick="btnCreate_Click" Width="100px">
                            </dx:ASPxButton>
                        </td>
                        <td>
                            &nbsp;
