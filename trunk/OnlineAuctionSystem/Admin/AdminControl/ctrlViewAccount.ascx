<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrlViewAccount.ascx.cs" Inherits="OnlineAuctionSystem.Admin.AdminControl.ctrlViewAccount" %>
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v11.1, Version=11.1.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>
<dx:ASPxButton ID="btnAdd" runat="server" Text="Thêm Tài Khoản Mới" 
...
<div style="padding-top:10px">
    ...
    <asp:GridView ID="gvAccount" runat="server" AllowPaging="True" 
        ...
        EmptyDataText="Xin lỗi, hiện tại không có tài khoản nào khác!" 
        ...
        <Columns>
            ...
            <asp:CommandField ButtonType="Image" HeaderText="Sửa" 
                SelectImageUrl="~/Admin/images/edit.png" ShowSelectButton="True">
            ...
            <asp:TemplateField HeaderText="Xóa" ShowHeader="False">
                <ItemTemplate>
                    <asp:ImageButton ID="ImageButton1" runat="server" CausesValidation="False" 
                        CommandName="Delete" ImageUrl="~/Admin/images/Delete.png" Text="Delete" OnClientClick="return confirm('Bạn có chắc muốn xóa tài khoản này?')"/>
                </ItemTemplate>
